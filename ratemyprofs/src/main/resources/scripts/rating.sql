INSERT INTO RATING(OVERALL_SCORE, DIFFICULTY_LEVEL, WILL_RETAKE, FOR_CREDIT, REQUIRE_TEXTBOOK, 
				   REQUIRE_ATTENDANCE, RECEIVED_GRADE, REVIEW, PROF_ID_PROF, COURSE_ID_COURSE, 
				   DEPT_ID_DEPT, COURSE_CODE, CREATED, MODIFIED, USER_ID_USER, RATING_STATUS) VALUES
...
INSERT INTO RATING(OVERALL_SCORE, DIFFICULTY_LEVEL, REVIEW, PROF_ID_PROF, COURSE_ID_COURSE, 
				   DEPT_ID_DEPT, COURSE_CODE, CREATED, MODIFIED, USER_ID_USER, RATING_STATUS) VALUES
	              (2, 4, 'We had to teach ourselves lots of things for the project. In a way it was good since we had to learn how to self teach, but for how much we're paying I don't think we should be left to follow online tutorials for so much of the course materials.', 
	               SELECT ID_PROF FROM PROF WHERE PROF_FIRST_NAME='Ilir' AND PROF_LAST_NAME='Dema',
...
INSERT INTO RATING(OVERALL_SCORE, DIFFICULTY_LEVEL, RECEIVED_GRADE, REVIEW, PROF_ID_PROF, COURSE_ID_COURSE, 
				   DEPT_ID_DEPT, COURSE_CODE, CREATED, MODIFIED, USER_ID_USER, RATING_STATUS) VALUES
	              (2, 4, 'A', 'Best prof ever, super caring. Definitely recommend!', 
	               SELECT ID_PROF FROM PROF WHERE PROF_FIRST_NAME='Ilir' AND PROF_LAST_NAME='Dema',
	               SELECT ID_COURSE FROM COURSE WHERE COURSE_CODE='CSCC01',
	               SELECT ID_DEPT FROM DEPT WHERE DEPT_NAME='Computer and Mathematical Sciences',
